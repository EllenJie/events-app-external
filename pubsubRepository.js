const PROJECTID = process.env.GOOGLE_CLOUD_PROJECT ? process.env.GOOGLE_CLOUD_PROJECT : "roigcp-hca-u118";
const SUBSCRIPTION = process.env.SUBSCRIPTION ? process.env.SUBSCRIPTION : "image_updated-sub1";
